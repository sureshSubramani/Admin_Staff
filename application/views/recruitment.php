                                                    ...
                                                    <div class='row'>
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 form-group has-feedback">
                                                                <input type="hidden" class='col-sm-5 col-md-5' id='type_of_address_1' value='Present' name="type_of_address[]" />
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="col-md-8 col-sm-8 form-group has-feedback">
                                                                <input type="hidden" class='col-sm-5 col-md-5' id='type_of_address_2' value='Permanent' name="type_of_address[]" />
